...
const UpdateCustomer = ({
  ...
  const getCountries=async ()=>{
    await customerServices.getCountries()
    .then((res)=>{
  ...
  const GetCustomersGroups=async ()=>{
    await customerServices.GetCustomersGroups()
    .then((res)=>{
        ...
        <Grid container spacing={4} >
          ...
          <Grid item xs={12}>
            <Grid container spacing={2} >
              ...
              <Grid item xs={4}>
                <TextField id="outlined-basic" fullWidth label="First Name" variant="outlined" required
                  value={data.name}
                  onChange={(e) => setData({ ...data, name: e.target.value })}
                />
              </Grid>
              <Grid item xs={4}>
                <TextField id="outlined-basic" fullWidth label="Last Name" variant="outlined" required
                  value={data.surname}
          ...
          <Grid item xs={12}>
            <Grid container spacing={2} >
              ...
              <Grid item xs={4}>
                <TextField id="outlined-basic" fullWidth label="Phone" variant="outlined"  required 
          ...
          <Grid item xs={12}>
            <Grid container >
              ...
              >
                ...
                <Grid item>
                  <Button primay variant="contained" type="Submit" >Update Customer</Button>
                </Grid>
