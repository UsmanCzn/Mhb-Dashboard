...
import NewRewardRedemption from '../newRewardRedemption';
export default function PointsRedemmTable({ selectedBrand,reload,customerGroups,setReload }) {
  ...
  return (
    ...
    />
     <Menu
      ...
      <NewRewardRedemption  modal={newModal} setModal={setNewModal} branchesList={branchesList}   setReload={setReload}  />
