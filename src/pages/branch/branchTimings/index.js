...
export default function BranchTimings() {
    ...
    return (
        <>
            ...
            <NewScedule modalOpen={modalOpen} setModalOpen={setModalOpen} updateData={data} branchId={id} setReload={setReload} />
            <Dialog
                open={deleteOpen}
