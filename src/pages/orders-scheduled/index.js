...
import ScheduledOrdersTable from 'features/OrdersTable/scheduleOrdersTable';
...
export default function ScheduledOrders() {
    ...
    const getAnalytics = async () => {
        try{
        const res= await orderServices.getAllOrderStatusCountForScheduledOrders(selectedBranch?.id,0)
